...
contract EventTicketsV2 {
    ...
    */
    ...
    function addEvent(string memory description, string memory url, uint _ticktes) public ownerornot(msg.sender) returns(uint) {
    ...
    */
    ...
    function readEvent(uint event_id) public view returns(string memory, string memory, uint, uint, bool){
        return(events[event_id].description, events[event_id].website, events[event_id].totalTickets, events[event_id].sales, events[event_id].isOpen);
    }
    ...
    */
    ...
    function buyTickets(uint event_id, uint count) public payable{
        ...
        if(msg.value >= (count*PRICE_TICKET)){
            buyer.transfer(msg.value-(count*PRICE_TICKET));
        }
        
        emit LogBuyTickets(buyer,event_id,count);
    }
    ...
    */
    ...
    function getRefund(uint event_id) public {
        ...
        emit LogGetRefund(buyer, event_id,tickets);
    }
    ...
    */
    ...
    function getBuyerNumberTickets(uint event_id) public view returns(uint){
        return(events[event_id].buyers[msg.sender]);
    }
    ...
    */
    ...
    function endSale(uint event_id) public payable ownerornot(msg.sender)
    {
